...
static inline void Xen_IGC_Write_Field(Xen_GCHandle** field, Xen_Instance* child) {
  Xen_GC_Write_Field((Xen_GCHandle**)field, (Xen_GCHeader*)child);
}

#define Xen_IGC_WRITE_FIELD(field, child)                                      \
  do {                                                                         \
    Xen_IGC_Write_Field((Xen_GCHandle**)&(field),  (Xen_Instance*)(child));    \
  } while (0)
