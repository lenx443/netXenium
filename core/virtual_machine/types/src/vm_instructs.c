...
static STACK_EFFECT(scope_push_stack_effect, 0)
static STACK_EFFECT(scope_pop_stack_effect, 0)
...
static STACK_EFFECT(make_function_async_stack_effect, -1)
...
static STACK_EFFECT(await_stack_effect, -1)
static STACK_EFFECT(await_resume_stack_effect, 1)
...
struct vm_Instruct_Info Instruct_Info_Table[HALT] = {
    ...
    [SCOPE_PUSH] =                {"SCOPE_PUSH",                scope_push_stack_effect,                0},
    [SCOPE_POP] =                 {"SCOPE_POP",                 scope_pop_stack_effect,                 0},
    ...
    [MAKE_FUNCTION_ASYNC] =       {"MAKE_FUNCTION_ASYNC",       make_function_async_stack_effect,       INSTRUCT_FLAG_CO_CALLABLE},
    ...
    [AWAIT_RESUME] =              {"AWAIT_RESUME",              await_resume_stack_effect,              0},
